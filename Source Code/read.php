            ...
            <div class=" right-box">
                ...
                <div class="detail">
                   ...
                   <?php echo $school_name ?> <br>
                    <?php  echo $school_marks ?> 

                   </div>

                  <div>
                  <h3> college </h3>
                  <?php echo $college_name ?> <br>
                  <?php echo $college_marks ?>  
                  </div>

                    <div>
                    <h3> Engineering</h3>
                    <?php echo $eng_college_name  ?> <br>
                    <?php echo  $eng_branch ?><br>
                    <?php echo  $eng_marks  ?>
                    </div>
                ...
                <div class="details">
                        ...
                        <div class="col" >
                        <label class="col-5 " > start date : <?php echo $start_date ?></label>
                        
                        <label class="col-5"> End Date <?php echo $end_date ?></label>
                        
                        </div>
    
                        <div>
                        <h4> Internship Description : </h4>
                        <?php echo $intern_desc ?>
                        </div>
